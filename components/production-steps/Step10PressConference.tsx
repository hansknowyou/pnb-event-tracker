...
import type { PressConference, MediaDesignItem } from '@/types/production';
...
export default function Step10PressConference({
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Press Conference Location</CardTitle>
        </CardHeader>
        <CardContent>
          <Input
      ...
      {[
        { key: 'invitationLetter', title: 'Invitation Letter' },
        { key: 'guestList', title: 'Guest List' },
        { key: 'pressRelease', title: 'Official Press Release' },
      ].map(({ key, title }) => (
        <Card key={key}>
          <CardHeader>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h4 className="text-lg font-semibold">Press Conference Media</h4>
        </div>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="e.g., Press Kit Visuals"
                  />
                </div>
